            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Restaurants Reviews <span class="fa fa-chevron-down"></span></a> </li>
                  <li><a><i class="fa fa-desktop"></i> Promotions <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-table"></i> Restaurants Profile <span class="fa fa-chevron-down"></span></a> </li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
