...
<head>
  ...
  <script>
      ...
      $("#consumer_registration").on("click", function(){
        alert("HOLA");
    });
</script>
</head>
<body>
    ...
    <ul class="tabs">
        <li class="tab-link current" data-tab="consumer_registration">Consumer</li>
        <li class="tab-link" data-tab="restaurant_registration">Restaurant</li>

    <div id="consumer_registration" class="tab-content current">
    ...
    <div id="restaurant_registration" class="tab-content">
          <fieldset> <legend>New account registry:</legend>
                <p>First Name:</p> 
                <input id="firstName" type="text" class="formElement" size="20"> 
                <span id="errorLabelFirstName" class="errorLabels"></span>
            ...
            <br>
            <p>Security Key:</p> 
                <input id="security_key" type="text" class="formElement" size="20"> 
                <span id="errorLabelFirstName" class="errorLabels"></span>
                <br>
                <br>
            <input class="buttons" type="submit" id="registerButton" value="Register"/>
